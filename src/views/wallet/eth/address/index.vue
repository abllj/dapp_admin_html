  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;"
        ...
        <el-table-column align="center" prop="addr" label="充币地址" />
...
<script>
  import crudEthAddress from '@/api/wallet/eth/address/EthAddress.js'
  import CRUD, {
    crud,
    form,
    header,
  ...
  export default {
    ...
    data() {
      return {
        ...
        permission: {
          add: ['admin', 'EthAddress:add'],
          edit: ['admin', 'EthAddress:edit'],
          del: ['admin', 'EthAddress:del']
        },
        rules: {
