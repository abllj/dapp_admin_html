  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;"
        ...
        <el-table-column align="center" prop="currencyName" label="币种名称" />
        ...
        <el-table-column align="center" prop="minAmount" label="最小提币量" />
        <el-table-column align="center" prop="maxAmount" label="最大提币量" />
...
<script>
  import crudWithdrawConfig from '@/api/withdraw/config/Config'
  import CRUD, {
    crud,
    form,
    header,
  ...
  export default {
    ...
    data() {
      return {
        ...
        permission: {
          add: ['admin', 'WithdrawConfig:add'],
          edit: ['admin', 'WithdrawConfig:edit'],
          del: ['admin', 'WithdrawConfig:del']
        },
        rules: {
          currency: [{
            required: true,
